			...
			>
				<AttachmentPreviewDialog>
					<TooltipTrigger asChild>
						<button
							type="button"
							className="aui-attachment-tile bg-muted size-14 cursor-pointer overflow-hidden rounded-[calc(var(--composer-radius)-var(--composer-padding))] border p-0 transition-opacity hover:opacity-75"
